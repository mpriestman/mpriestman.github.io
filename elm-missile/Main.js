...
var _user$project$Vec2$angleBetween = F2(
	function (a, b) {
		var yDiff = b.y - a.y;
		var xDiff = b.x - a.x;
		return A2(_elm_lang$core$Basics$atan2, xDiff, yDiff);
	});
var _user$project$Vec2$asTuple = function (point) {
	return {ctor: '_Tuple2', _0: point.x, _1: point.y};
};
var _user$project$Vec2$wrapFloat = F3(
	function (input, min, max) {
		var size = max - min;
		return (_elm_lang$core$Native_Utils.cmp(input, min) < 0) ? (input + size) : ((_elm_lang$core$Native_Utils.cmp(input, max) > -1) ? (input - size) : input);
	});
var _user$project$Vec2$wrapVec2 = F2(
	function (_p0, input) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = _p1._1;
		return {
			x: A3(_user$project$Vec2$wrapFloat, input.x, _p3.x, _p2.x),
			y: A3(_user$project$Vec2$wrapFloat, input.y, _p3.y, _p2.y)
		};
	});
var _user$project$Vec2$randomVec2Y = F3(
	function (x, min, max) {
		return A2(
			_elm_lang$core$Random$map,
			function (y) {
...
var _user$project$Vec2$randomVec2X = F3(
	function (y, min, max) {
		return A2(
			_elm_lang$core$Random$map,
			function (x) {
...
var _user$project$Vec2$randomVec2InBounds = function (_p4) {
	var _p5 = _p4;
	var _p7 = _p5._0;
	var _p6 = _p5._1;
	return A3(
		...
		A2(_elm_lang$core$Random$float, _p7.x, _p6.x),
		A2(_elm_lang$core$Random$float, _p7.y, _p6.y));
};
var _user$project$Vec2$randomVec2 = F2(
	function (min, max) {
		return A3(
			_elm_lang$core$Random$map2,
			F2(
...
var _user$project$Vec2$length = function (v) {
	return _elm_lang$core$Basics$sqrt((v.x * v.x) + (v.y * v.y));
};
var _user$project$Vec2$rotate = F2(
	function (a, v) {
		var sina = _elm_lang$core$Basics$sin(a);
		var cosa = _elm_lang$core$Basics$cos(a);
		return {x: (v.x * cosa) - (v.y * sina), y: (v.x * sina) + (v.y * cosa)};
	});
var _user$project$Vec2$subtract = F2(
	function (v1, v2) {
		return {x: v1.x - v2.x, y: v1.y - v2.y};
	});
var _user$project$Vec2$distance = F2(
	function (v1, v2) {
		return _user$project$Vec2$length(
			A2(_user$project$Vec2$subtract, v1, v2));
	});
var _user$project$Vec2$circlesOverlap = F2(
	function (_p9, _p8) {
		var _p10 = _p9;
		var _p11 = _p8;
		return _elm_lang$core$Native_Utils.cmp(
			A2(_user$project$Vec2$distance, _p10._0, _p11._0),
			_p10._1 + _p11._1) < 1;
	});
var _user$project$Vec2$add = F2(
	function (v1, v2) {
		return {x: v1.x + v2.x, y: v1.y + v2.y};
	});
var _user$project$Vec2$scale = F2(
	function (a, v) {
		return {x: v.x * a, y: v.y * a};
	});
var _user$project$Vec2$normalise = function (v) {
	var s = 1.0 / _user$project$Vec2$length(v);
	return A2(_user$project$Vec2$scale, s, v);
};
var _user$project$Vec2$origin = {x: 0, y: 0};
var _user$project$Vec2$Vec2 = F2(
	function (a, b) {
		return {x: a, y: b};
	});

var _user$project$Model$cloudHit = F2(
	function (point, exp) {
		var dist = A2(_user$project$Vec2$distance, point, exp.position);
		return _elm_lang$core$Native_Utils.cmp(dist, exp.size) < 0;
	});
var _user$project$Model$detonateMissile = function (missile) {
	var distToTarget = A2(_user$project$Vec2$distance, missile.position, missile.target);
	return _elm_lang$core$Native_Utils.cmp(distToTarget, 4.0) < 0;
};
var _user$project$Model$moveMissile = function (missile) {
	var newPosition = A2(_user$project$Vec2$add, missile.velocity, missile.position);
	return _elm_lang$core$Native_Utils.update(
		missile,
		{position: newPosition});
};
var _user$project$Model$missileColour = function (kind) {
	var _p0 = kind;
	if (_p0.ctor === 'Player') {
		return 'blue';
	} else {
...
var _user$project$Model$makeMissile = F4(
	function (kind, speed, start, target) {
		var colour = _user$project$Model$missileColour(kind);
		var dir = _user$project$Vec2$normalise(
			A2(_user$project$Vec2$subtract, target, start));
		var v = A2(_user$project$Vec2$scale, speed, dir);
		return {target: target, launch: start, position: start, velocity: v, colour: colour};
	});
var _user$project$Model$distanceTo = F2(
	function (point, base) {
		return A2(_user$project$Vec2$distance, point, base.position);
	});
var _user$project$Model$nonEmptyBases = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		function (s) {
			return _elm_lang$core$Native_Utils.cmp(s.numMissiles, 0) > 0;
		},
		model.bases);
};
var _user$project$Model$firstNonEmptyBase = function (model) {
	return _elm_lang$core$List$head(
		_user$project$Model$nonEmptyBases(model));
};
var _user$project$Model$nearestBase = F2(
	function (point, model) {
		var bases = A2(
			_elm_lang$core$List$sortBy,
			_user$project$Model$distanceTo(point),
			_user$project$Model$nonEmptyBases(model));
		return _elm_lang$core$List$head(bases);
	});
var _user$project$Model$makePoint = F2(
	function (x, y) {
		return {
			x: _elm_lang$core$Basics$toFloat(x),
			y: _elm_lang$core$Basics$toFloat(y)
		};
	});
var _user$project$Model$removeMissile = F2(
	function (id, base) {
		return _elm_lang$core$Native_Utils.eq(base.id, id) ? _elm_lang$core$Native_Utils.update(
			base,
			{numMissiles: base.numMissiles - 1}) : base;
	});
var _user$project$Model$maybeRemoveMissile = F2(
	function (base, bases) {
		var _p1 = base;
		if (_p1.ctor === 'Just') {
			return A2(
				_elm_lang$core$List$map,
				_user$project$Model$removeMissile(_p1._0.id),
				bases);
		} else {
			return bases;
		}
	});
var _user$project$Model$maybeAddMissile = F2(
	function (missile, list) {
		var _p2 = missile;
		if (_p2.ctor === 'Just') {
			return A2(_elm_lang$core$List_ops['::'], _p2._0, list);
		} else {
			return list;
		}
	});
var _user$project$Model$notDone = function (exp) {
	return _elm_lang$core$Native_Utils.cmp(exp.inc, 1.0) < 1;
};
var _user$project$Model$easeExplosion = function (time) {
	return (_elm_lang$core$Native_Utils.cmp(time, 0.5) < 0) ? _elm_community$easing_functions$Ease$linear(time * 2.0) : (1.0 - _elm_community$easing_functions$Ease$linear((time - 0.5) * 2.0));
};
var _user$project$Model$growExplosion = function (exp) {
	var newInc = exp.inc + 1.0e-2;
	var newSize = _user$project$Model$easeExplosion(newInc) * 30.0;
	return _elm_lang$core$Native_Utils.update(
		exp,
		{inc: newInc, size: newSize});
};
var _user$project$Model$createExplosion = function (missile) {
	return {position: missile.position, inc: 0.0, size: 0.0};
};
var _user$project$Model$baseHit = F2(
	function (explosions, base) {
		var hits = A2(
			_elm_lang$core$List$map,
			_user$project$Model$cloudHit(base.position),
			explosions);
		return A2(
			_elm_lang$core$List$any,
			function (hit) {
			...
			hits) ? _elm_lang$core$Native_Utils.update(
			base,
			{numMissiles: 0}) : base;
	});
var _user$project$Model$missileHit = F2(
	function (explosions, missile) {
		var hits = A2(
			_elm_lang$core$List$map,
			_user$project$Model$cloudHit(missile.position),
			explosions);
		return A2(
			_elm_lang$core$List$any,
			function (b) {
...
var _user$project$Model$cityHit = F2(
	function (explosions, city) {
		var hits = A2(
			_elm_lang$core$List$map,
			_user$project$Model$cloudHit(city.position),
			explosions);
		return A2(
			_elm_lang$core$List$all,
			function (hit) {
				return _elm_lang$core$Basics$not(hit);
			},
			hits);
	});
var _user$project$Model$detonateMissiles = function (missiles) {
	var _p3 = A2(_elm_lang$core$List$partition, _user$project$Model$detonateMissile, missiles);
	var toDetonate = _p3._0;
	var toKeep = _p3._1;
	var explosions = A2(_elm_lang$core$List$map, _user$project$Model$createExplosion, toDetonate);
	return {ctor: '_Tuple2', _0: explosions, _1: toKeep};
};
var _user$project$Model$explodeNukes = function (model) {
	var _p4 = A2(
		_elm_lang$core$List$partition,
		_user$project$Model$missileHit(model.explosions),
		model.nukes);
	var toExplode = _p4._0;
	var toKeep = _p4._1;
	var explosions = A2(_elm_lang$core$List$map, _user$project$Model$createExplosion, toExplode);
	return {ctor: '_Tuple2', _0: explosions, _1: toKeep};
};
var _user$project$Model$countdown = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{countdown: model.countdown - 1});
};
var _user$project$Model$destroyBases = function (model) {
	var bases$ = A2(
		_elm_lang$core$List$map,
		_user$project$Model$baseHit(model.explosions),
		model.bases);
	return _elm_lang$core$Native_Utils.update(
		model,
		{bases: bases$});
};
var _user$project$Model$destroyCities = function (model) {
	var cities$ = A2(
		_elm_lang$core$List$filter,
		_user$project$Model$cityHit(model.explosions),
		model.cities);
	return _elm_lang$core$Native_Utils.update(
		model,
		{cities: cities$});
};
var _user$project$Model$moveMissiles = function (model) {
	var nukes$ = A2(_elm_lang$core$List$map, _user$project$Model$moveMissile, model.nukes);
	var missiles$ = A2(_elm_lang$core$List$map, _user$project$Model$moveMissile, model.missiles);
	return _elm_lang$core$Native_Utils.update(
		model,
		{missiles: missiles$, nukes: nukes$});
};
var _user$project$Model$detonateAllMissiles = function (model) {
	var _p5 = _user$project$Model$detonateMissiles(model.missiles);
	var missileExplosions = _p5._0;
	var missiles$ = _p5._1;
	var _p6 = _user$project$Model$detonateMissiles(model.nukes);
	var nukeExplosions = _p6._0;
	var nukes$ = _p6._1;
	var explosions$ = A2(
		_elm_lang$core$Basics_ops['++'],
		model.explosions,
		A2(_elm_lang$core$Basics_ops['++'], nukeExplosions, missileExplosions));
	return _elm_lang$core$Native_Utils.update(
		model,
		{explosions: explosions$, nukes: nukes$, missiles: missiles$});
};
var _user$project$Model$scorePerNuke = 25;
var _user$project$Model$destroyNukes = function (model) {
	var _p7 = _user$project$Model$explodeNukes(model);
	var explosions = _p7._0;
	var nukes$ = _p7._1;
	var scoreInc = _elm_lang$core$List$length(explosions) * _user$project$Model$scorePerNuke;
	var score$ = model.score + scoreInc;
	var explosions$ = A2(_elm_lang$core$Basics_ops['++'], model.explosions, explosions);
	return _elm_lang$core$Native_Utils.update(
		model,
		{explosions: explosions$, nukes: nukes$, score: score$});
};
var _user$project$Model$updateExplosions = function (model) {
	var explosions$ = A2(
		_elm_lang$core$List$filter,
		_user$project$Model$notDone,
		A2(_elm_lang$core$List$map, _user$project$Model$growExplosion, model.explosions));
	return _elm_lang$core$Native_Utils.update(
		model,
		{explosions: explosions$});
};
var _user$project$Model$stepModel = function (model) {
	return _user$project$Model$countdown(
		_user$project$Model$destroyBases(
			_user$project$Model$destroyCities(
				_user$project$Model$detonateAllMissiles(
					_user$project$Model$destroyNukes(
						_user$project$Model$moveMissiles(
							_user$project$Model$updateExplosions(model)))))));
};
var _user$project$Model$isLevelOver = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.nukes),
		0) && (_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.explosions),
		0) && _elm_lang$core$Native_Utils.eq(model.nukesLeft, 0));
};
var _user$project$Model$isGameOver = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.cities),
		0) && _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.explosions),
		0);
};
var _user$project$Model$speedForNuke = function (model) {
	return 0.4 + (5.0e-2 * _elm_lang$core$Basics$toFloat(model.level - 1));
};
var _user$project$Model$updateCountdown = F2(
	function (c, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{countdown: c});
	});
var _user$project$Model$toState = F2(
...
var _user$project$Model$targetFromIndex$ = function (i) {
	return A2(_user$project$Model$makePoint, i * 80, 350);
};
var _user$project$Model$targetFromIndex = function (i) {
	var _p9 = i;
	switch (_p9) {
		case 1:
			return A2(_user$project$Model$makePoint, 40, 330);
		case 2:
			return A2(_user$project$Model$makePoint, 120, 350);
		case 3:
			return A2(_user$project$Model$makePoint, 240, 350);
		case 4:
			return A2(_user$project$Model$makePoint, 330, 350);
		case 5:
			return A2(_user$project$Model$makePoint, 400, 330);
		case 9:
			return A2(_user$project$Model$makePoint, 760, 330);
		default:
			return _user$project$Model$targetFromIndex$(i);
	}
};
var _user$project$Model$positions = function (list) {
	return A2(_elm_lang$core$List$map, _user$project$Model$targetFromIndex, list);
};
var _user$project$Model$cityPositions = _elm_lang$core$Native_List.fromArray(
	[2, 3, 4, 6, 7, 8]);
var _user$project$Model$defaultCities = function () {
	var pos = _user$project$Model$positions(_user$project$Model$cityPositions);
	var cities = A2(
		_elm_lang$core$List$map,
		function (p) {
			return {position: p};
...
var _user$project$Model$basePositions = _elm_lang$core$Native_List.fromArray(
	[1, 5, 9]);
var _user$project$Model$defaultBases = function () {
	var pos = _user$project$Model$positions(_user$project$Model$basePositions);
	var pairs = A3(
		_elm_lang$core$List$map2,
		F2(
			function (v0, v1) {
		...
		pos,
		_user$project$Model$basePositions);
	var bases = A2(
		_elm_lang$core$List$map,
		function (_p10) {
			var _p11 = _p10;
			return {id: _p11._1, position: _p11._0, numMissiles: 10};
		},
		pairs);
	return bases;
}();
var _user$project$Model$scoringInterval = function (model) {
	var _p12 = _user$project$Model$numMissilesLeft(model);
	if (_p12 === 0) {
		return 500 * _elm_lang$core$Time$millisecond;
	} else {
		return 100 * _elm_lang$core$Time$millisecond;
	}
};
var _user$project$Model$Base = F3(
	function (a, b, c) {
		return {id: a, position: b, numMissiles: c};
	});
var _user$project$Model$City = function (a) {
	return {position: a};
};
var _user$project$Model$Missile = F5(
	function (a, b, c, d, e) {
		return {position: a, target: b, launch: c, velocity: d, colour: e};
	});
var _user$project$Model$Explosion = F3(
	function (a, b, c) {
		return {position: a, inc: b, size: c};
	});
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {missiles: a, nukes: b, explosions: c, bases: d, cities: e, nukesLeft: f, countdown: g, level: h, state: i, score: j, citiesScored: k, missilesScored: l};
											};
										};
									};
								};
...
var _user$project$Model$NextLevel = {ctor: 'NextLevel'};
var _user$project$Model$LaunchNuke = function (a) {
	return {ctor: 'LaunchNuke', _0: a};
};
var _user$project$Model$launchNukeCommand = A2(
	_elm_lang$core$Random$generate,
	_user$project$Model$LaunchNuke,
	A2(
		_elm_lang$core$Random$pair,
		A2(_elm_lang$core$Random$int, 0, 800),
		A2(_elm_lang$core$Random$int, 1, 9)));
var _user$project$Model$nextCommand = function (model) {
	var _p13 = model.countdown;
	if (_p13 === 0) {
		return _user$project$Model$launchNukeCommand;
	} else {
		return _elm_lang$core$Platform_Cmd$none;
	}
};
var _user$project$Model$NextCountdown = function (a) {
	return {ctor: 'NextCountdown', _0: a};
};
var _user$project$Model$countdownCommand = A2(
	_elm_lang$core$Random$generate,
	_user$project$Model$NextCountdown,
	A2(_elm_lang$core$Random$int, 10, 100));
var _user$project$Model$AddMissile = function (a) {
	return {ctor: 'AddMissile', _0: a};
};
var _user$project$Model$Frame = function (a) {
	...
	switch (_p14.ctor) {
		...
		case 'LevelEnd':
			return A2(
				...
				_user$project$Model$Tick);
		default:
			return _elm_lang$core$Platform_Sub$none;
	}
};
var _user$project$Model$Enemy = {ctor: 'Enemy'};
var _user$project$Model$makeNuke = _user$project$Model$makeMissile(_user$project$Model$Enemy);
var _user$project$Model$launchNukeFrom = F3(
	function (launch, target, model) {
		var nukesLeft$ = model.nukesLeft - 1;
		var speed = _user$project$Model$speedForNuke(model);
		var targetPos = _user$project$Model$targetFromIndex(target);
		var newNukes = A2(
			_elm_lang$core$List_ops['::'],
			A3(_user$project$Model$makeNuke, speed, launch, targetPos),
			model.nukes);
		return _elm_lang$core$Native_Utils.update(
			model,
			{nukes: newNukes, nukesLeft: nukesLeft$});
	});
var _user$project$Model$launchNuke = F3(
	function (from, target, model) {
		var _p15 = model.nukesLeft;
		if (_p15 === 0) {
			...
			return {
				ctor: '_Tuple2',
				_0: A3(
					_user$project$Model$launchNukeFrom,
					A2(_user$project$Model$makePoint, from, 0),
					target,
					model),
				_1: _user$project$Model$countdownCommand
			};
		}
	});
var _user$project$Model$Player = {ctor: 'Player'};
var _user$project$Model$makeBaseMissile = F2(
	function (base, target) {
		var _p16 = base;
		if (_p16.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(
				A4(_user$project$Model$makeMissile, _user$project$Model$Player, 8.0, _p16._0.position, target));
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Model$addMissile = F2(
	function (point, model) {
		var base = A2(_user$project$Model$nearestBase, point, model);
		var missile = A2(_user$project$Model$makeBaseMissile, base, point);
		var newMissiles = A2(_user$project$Model$maybeAddMissile, missile, model.missiles);
		var newBases = A2(_user$project$Model$maybeRemoveMissile, base, model.bases);
		return _elm_lang$core$Native_Utils.update(
			model,
			{missiles: newMissiles, bases: newBases});
	});
var _user$project$Model$GameOver = {ctor: 'GameOver'};
var _user$project$Model$gameOver = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			...
			missiles: _elm_lang$core$Native_List.fromArray(
				[]),
			state: _user$project$Model$GameOver
		});
};
...
var _user$project$Model$updateModel = function (model) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Model$nextStep(model),
		_1: _user$project$Model$nextCommand(model)
	};
};
var _user$project$Model$Playing = {ctor: 'Playing'};
var _user$project$Model$nextLevel = function (model) {
	var level$ = model.level + 1;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			level: level$,
			nukesLeft: _user$project$Model$nukesForLevel(level$),
			countdown: 0,
			...
			cities: _elm_lang$core$List$reverse(model.citiesScored),
			citiesScored: _elm_lang$core$Native_List.fromArray(
				[]),
			missilesScored: 0
		});
};
...
var _user$project$Model$update = F2(
	function (msg, model) {
		...
		switch (_p20.ctor) {
			...
			case 'Frame':
				return _user$project$Model$updateModel(model);
			case 'AddMissile':
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Model$addMissile,
						A2(_user$project$Model$makePoint, _p20._0._0, _p20._0._1),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NextCountdown':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$updateCountdown, _p20._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LaunchNuke':
				return A3(_user$project$Model$launchNuke, _p20._0._0, _p20._0._1, model);
			case 'NextLevel':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Model$nextLevel(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$keyPress, _p20._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$View$getClickPos = A3(
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['offsetY']),
		_elm_lang$core$Json_Decode$int));
var _user$project$View$centeredText = function (caption) {
	return A2(
...
var _user$project$View$viewGameOver = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View$beginButton = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$svg$Svg_Events$onClick(_user$project$Model$NextLevel)
		]),
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$View$caption = A2(
	_elm_lang$svg$Svg$text$,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View$viewIntro = _elm_lang$core$Native_List.fromArray(
	[_user$project$View$caption, _user$project$View$beginButton]);
var _user$project$View$viewExplosion = function (exp) {
	return A2(
		_elm_lang$svg$Svg$circle,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$cx(
				_elm_lang$core$Basics$toString(exp.position.x)),
				_elm_lang$svg$Svg_Attributes$cy(
				_elm_lang$core$Basics$toString(exp.position.y)),
				_elm_lang$svg$Svg_Attributes$r(
				_elm_lang$core$Basics$toString(exp.size)),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(missile.launch.x)),
				_elm_lang$svg$Svg_Attributes$y1(
				_elm_lang$core$Basics$toString(missile.launch.y)),
				_elm_lang$svg$Svg_Attributes$x2(
				_elm_lang$core$Basics$toString(missile.position.x)),
				_elm_lang$svg$Svg_Attributes$y2(
				_elm_lang$core$Basics$toString(missile.position.y)),
				_elm_lang$svg$Svg_Attributes$stroke(missile.colour),
...
var _user$project$View$viewBase = function (base) {
	return A2(
		_elm_lang$svg$Svg$circle,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(base.position.x)),
				_elm_lang$svg$Svg_Attributes$cy(
				_elm_lang$core$Basics$toString(base.position.y)),
				_elm_lang$svg$Svg_Attributes$r('10'),
				_elm_lang$svg$Svg_Attributes$fill(
				_user$project$View$baseColour(base))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$View$translatePoints = F3(
...
var _user$project$View$pointListAtPosition = F3(
	function (x1, y1, points) {
...
var _user$project$View$cityAtPosition = F2(
	function (x1, y1) {
		return A3(_user$project$View$pointListAtPosition, x1, y1, _user$project$View$cityPoints);
	});
var _user$project$View$renderCity = F2(
	function (x, y) {
		var p = A2(_user$project$View$cityAtPosition, x, y);
		return A2(
			_elm_lang$svg$Svg$polygon,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$points(p),
					_elm_lang$svg$Svg_Attributes$fill('cyan')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$View$viewCity = function (city) {
	return A2(_user$project$View$renderCity, city.position.x, city.position.y);
};
...
var _user$project$View$missileStorageLocations = _elm_lang$core$Native_List.fromArray(
	[
		...
		{ctor: '_Tuple2', _0: 16, _1: 16},
		{ctor: '_Tuple2', _0: -24, _1: 24},
		{ctor: '_Tuple2', _0: -8, _1: 24},
		{ctor: '_Tuple2', _0: 8, _1: 24},
		{ctor: '_Tuple2', _0: 24, _1: 24}
	]);
var _user$project$View$missilePoints = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View$missileAtPosition = F2(
	function (x1, y1) {
...
var _user$project$View$viewState = function (model) {
	...
	switch (_p9.ctor) {
		...
		case 'GameOver':
			return _user$project$View$viewGameOver(model);
		default:
			return _elm_lang$core$Native_List.fromArray(
				[]);
	}
};
var _user$project$View$groundPoints = '0,400 0,350 10,350 30,330 50,330 70,350 370,350 390,330 410,330 430,350 730,350 750,330 770,330 790,350 800,350 800,400';
var _user$project$View$viewGround = A2(
	_elm_lang$svg$Svg$polygon,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$svg$Svg_Attributes$points(_user$project$View$groundPoints),
	...
	var svgBackground = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$html$Html_Events$on,
				'click',
				A2(_elm_lang$core$Json_Decode$map, _user$project$Model$AddMissile, _user$project$View$getClickPos))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
	var svgElements = _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_List.fromArray(
				...
				A2(_elm_lang$core$List$map, _user$project$View$viewExplosion, model.explosions),
				_user$project$View$viewState(model),
				_user$project$View$viewScore(model)
			]));
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$class('game-svg'),
				_elm_lang$svg$Svg_Attributes$viewBox('0 0 800 400')
			]),
		svgElements);
};
var _user$project$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$viewGame(model)
			]));
};
